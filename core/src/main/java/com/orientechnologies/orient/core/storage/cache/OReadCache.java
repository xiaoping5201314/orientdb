...
public interface OReadCache {
  ...
  OCacheEntry loadForWrite(long fileId, long pageIndex, boolean checkPinnedPages, OWriteCache writeCache, int pageCount) throws IOException;

  void releaseFromWrite(OCacheEntry cacheEntry, OWriteCache writeCache);

  OCacheEntry loadForRead(long fileId, long pageIndex, boolean checkPinnedPages, OWriteCache writeCache, int pageCount) throws IOException;
